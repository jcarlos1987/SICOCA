Public Class creditosPatronEjecutor
    ...
    Protected Sub GridView2_PreRender(ByVal sender As Object, ByVal e As EventArgs) Handles GridView2.PreRender
        GridView2.Caption = "<font style='font-size: large; color: #CC6600; font-weight: bold;'>" & GridView2.Rows.Count & " CREDITOS A CAPTURAR<br/>" & Request.QueryString("razonsocial").ToString & "</font>"
    End Sub
End Class