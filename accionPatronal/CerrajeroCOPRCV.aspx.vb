...
Public Class CerrajeroCOPRCV
        ...
        Else
            If Session.Item("SIRECAprintPaeDoc").ToString.Equals("1") Then
                ...
                If Session.Item("SIRECAsubdel").ToString.Equals("01") Then
                    ...
                    LJefeOficinaCobros.Text = "EL JEFE DE LA OFICINA PARA COBROS M&Eacute;RIDA NORTE"
                ...
                Else
                    ...
                    LJefeOficinaCobros33.Text = "EL JEFE DE LA OFICINA PARA COBROS M&Eacute;RIDA SUR"
    ...
    Public Sub crearPDF()
        ...
        Dim PDF_FileName As String = Server.MapPath("~") + "/temp/docPae/P" & Request.QueryString("regpat").ToString.Replace("-", "") & "C" & Session.Item("SIRECAid").ToString & Request.QueryString("tipo").ToString & ".pdf"
        '-------------------------------
        ...
        htmlparser.Parse(sr)
        pdfDoc.Close()
        Response.Redirect("../temp/docPae/P" & Request.QueryString("regpat").ToString.Replace("-", "") & "C" & Session.Item("SIRECAid").ToString & Request.QueryString("tipo").ToString & ".pdf")
        'Dim client As WebClient = New WebClient()
        'Dim buffer As Byte() = client.DownloadData(Server.MapPath("~") + "/temp/docPae/Panel" & Request.QueryString("regpat").ToString.Replace("-", "") & "C" & Session.Item("SIRECAid").ToString & ".pdf")
