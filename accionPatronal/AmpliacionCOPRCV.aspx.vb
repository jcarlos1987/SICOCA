...
Public Class AmpliacionCOPRCV
        ...
        Else
            If Session.Item("SIRECAprintPaeDoc").ToString.Equals("1") Then
                ...
                If Session.Item("SIRECAsubdel").ToString.Equals("01") Then
                    ...
                    LNombreJefeOficinaCobros2.Text = "LIC. YAJAIRA MARIA CAMPOS SABIDO"
                ...
                Else
                    ...
                    LNombreJefeOficinaCobros2.Text = "JULIA PATRICIA LEAL MARIN"
    ...
    Public Sub crearPDF()
        ...
        Dim PDF_FileName As String = Server.MapPath("~") + "/temp/docPae/P" & Request.QueryString("regpat").ToString.Replace("-", "") & "A" & Session.Item("SIRECAid").ToString & Request.QueryString("tipo").ToString & ".pdf"
        '-------------------------------
        ...
        htmlparser.Parse(sr)
        pdfDoc.Close()
        Response.Redirect("../temp/docPae/P" & Request.QueryString("regpat").ToString.Replace("-", "") & "A" & Session.Item("SIRECAid").ToString & Request.QueryString("tipo").ToString & ".pdf")
        'Dim client As WebClient = New WebClient()
        'Dim buffer As Byte() = client.DownloadData(Server.MapPath("~") + "/temp/docPae/Panel" & Request.QueryString("regpat").ToString.Replace("-", "") & "A" & Session.Item("SIRECAid").ToString & ".pdf")
