...
Public Class conveniosReporte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.conveniosReporte.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedconveniosReporte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As conveniosReporte = New conveniosReporte()
        rpt.Site = Me.Site
        Return rpt
    End Function
