<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cobrosAsignados.aspx.vb" Inherits="WebSIRECA.cobrosAsignadoscobros" %>
...
WHERE (eco.responsable = ?) AND (eco.subdel = ?) AND year(eco.fechaSeleccion)=? and month(eco.fechaSeleccion)=?
ORDER BY emi_sec, EMIP_DOM">
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="00000" Name="?" 
                    QueryStringField="userid" />
                <asp:ControlParameter ControlID="DDLSubdel" 
                    DefaultValue="00" Name="?" PropertyName="SelectedValue" />
        ...
        <asp:SqlDataSource ID="SqlDataSourceResumenIncidencias" runat="server" 
            ...
            ProviderName="<%$ ConnectionStrings:ConnectionStringMaster.ProviderName %>" SelectCommand="DECLARE @RESPONSABLE VARCHAR(5)
DECLARE @SUBDEL VARCHAR(2)
