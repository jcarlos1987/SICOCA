<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="diligenciarsivepa.aspx.vb" Inherits="WebSIRECA.diligenciarsivepa" %>
                    ...
                    <asp:Panel ID="Panel3" runat="server" BackColor="#99CB99" Height="300px" 
                        ...
                        <td>&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:HyperLink ID="HyperLink1" rel="gb_page_fs[]" title="Archivo(s)" runat="server" >
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Panel ID="Panel1" runat="server" GroupingText="Observacón">
                                        <asp:TextBox ID="TBObservacion" runat="server" BorderStyle="None" BorderWidth="1px" 
    ...
    <asp:Panel ID="Panel5" runat="server" BackColor="#D8D8D8" >
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
            ...
            <Fields>
                ...
                <asp:TemplateField HeaderText="DILIGENCIA(S)">
                    <ItemTemplate>
                        <asp:GridView ID="GridViewDiliSivepa" runat="server" 
                            AutoGenerateColumns="False" DataSourceID="SqlDataSourceDiliSivepa" 
                            Font-Size="9pt" AllowPaging="True" PageSize="6">
                            <Columns>
...
,[SVD_FECH_DILI] as FECH_DILIGENCIA
,(select ACTIVIDAD from sireca.dbo.catalogo where [CVE DILIG#]=[SVD_DILI]) as DILIGENCIA
,[SVD_OBSERV] as OBSERVACION
FROM [sirecasivepas].[dbo].[SV_DILI_BASE]
inner join [sirecasivepas].[dbo].[SV_BASE]
on [SVD_SV_ID]=[SV_ID]
WHERE [SVD_SV_ID]=?
order by [SVD_FECH_DILI] desc">
                            <SelectParameters>
...
FROM [sirecasivepas].[dbo].[SV_CPATRONAL] as eco LEFT JOIN sireca.dbo.patrones as ptn on substring([CPSV_REGPAT],1,10)=ptn.regpat
left join [sirecasivepas].[dbo].[SV_BASE]
on [SV_REG_PATRONAL]=[CPSV_REGPAT]
where SV_SUBDEL=?
and SV_ASIG_INSPECTOR=?
and SV_ID=?
">
            <SelectParameters>
                <asp:SessionParameter DefaultValue="01" Name="?" SessionField="SIRECAsubdel" />
