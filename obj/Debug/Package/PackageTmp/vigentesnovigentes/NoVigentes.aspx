<%@ Page Language="vb" MasterPageFile ="~/sitios/SiteCiclo2.Master" AutoEventWireup="false" CodeBehind="NoVigentes.aspx.vb" Inherits="WebSIRECA.NoVigentes" %>

<asp:Content ID ="contenido" runat ="server" ContentPlaceHolderID ="ContentPlaceHolder1" >
    <div>
        <asp:Label ID="Label2" runat="server" Text="NO VIGENTES DEL " Font-Bold="True"></asp:Label>
        ...
        <asp:GridView ID="GridView1" runat="server" BackColor="White" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="vigencia" HeaderText="vigencia" 
                    SortExpression="vigencia" DataFormatString="{0:d}" />
            </Columns>
  ...
  where mov in ('2') and mov in ('9999')
