<%@ Page Language="vb" MasterPageFile ="~/Site2.Master" AutoEventWireup="false" CodeBehind="Webcop187.aspx.vb" Inherits="WebSIRECA.Webcop187" %>
<asp:Content ID="content1" runat ="server" ContentPlaceHolderID ="ContentPlaceHolder1" >
    <div>
    
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" 
            CellPadding="3" CellSpacing="1" DataSourceID="SqlDataSourceCOP187" Font-Size="9pt" 
            GridLines="None">
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="TIPO_PERSONA,REGPATR" 
                    DataNavigateUrlFormatString="documento.aspx?tipodoc=ACUERDO187_{0}&amp;REGPATR={1}" 
...
<SortedDescendingHeaderStyle BackColor="#33276A"></SortedDescendingHeaderStyle>
        ...
        <asp:SqlDataSource ID="SqlDataSourceCOP187" runat="server" 
