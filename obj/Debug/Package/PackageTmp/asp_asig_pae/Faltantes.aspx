<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Faltantes.aspx.vb" Inherits="WebSIRECA.Faltantes1" %>
...
, eco.RECARGOS, eco.MULTA, eco.TOTAL, eco.fechaEco,  (SELECT [nombre] FROM [fiscamovil].[dbo].[Usuarios] where [id]=eco.responsable) as responsable, eco.fechaSeleccion
...
WHERE (eco.subdel = ?) AND eco.fechaEco=? and incidencia in ('2') and cambiarIncidenciaPae in ('9')
order by sector,2">
            <SelectParameters>
