<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="imprimir.aspx.vb" Inherits="WebSIRECA.imprimir1" %>
...
WHERE (eco.responsablePae = ?) AND (eco.subdel = ?) AND convert(varchar(11),eco.fechaSeleccionPae)= substring(?,1,11)
