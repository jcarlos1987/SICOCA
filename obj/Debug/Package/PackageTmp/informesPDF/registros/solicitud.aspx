<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="solicitud.aspx.vb" Inherits="WebSIRECA.solicitud1" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSourceSolicitud" runat="server">
            <Report FileName="solicitud.rpt">
                <DataSources>
                    <CR:DataSourceRef DataSourceID="SqlDataSourceSolicitud" 
        ...
        <asp:SqlDataSource ID="SqlDataSourceSolicitud" runat="server" 
