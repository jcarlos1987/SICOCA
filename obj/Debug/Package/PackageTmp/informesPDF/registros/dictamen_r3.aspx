<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dictamen_r3.aspx.vb" Inherits="WebSIRECA.dictamen_r31" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSourceDictamen" runat="server">
            <Report FileName="dictamen_r3.rpt">
                <DataSources>
                    <CR:DataSourceRef DataSourceID="SqlDataSourceDictamen" 
        ...
        <asp:SqlDataSource ID="SqlDataSourceDictamen" runat="server" 
...
select substring('''+@RALECOP+''',13,2) as RALE_USADO,rale.* 
...
from (
SELECT RALE_USADO,[REGPATR],[FMOV] as FECH_MOV,sirecacobros.dbo.CantidadEnLetra(SUM([IMPORTE])) as IMPORTE_TOTAL_LETRAS
FROM [tempdb].[dbo].[registros_doc'+@ID_INTEGRADOR+@SUBDEL+']
where mov=''2'' and inc=''09'' and [REGPATR]='''+@REGPAT+'''
group by RALE_USADO,[REGPATR],[FMOV]
) as rale
