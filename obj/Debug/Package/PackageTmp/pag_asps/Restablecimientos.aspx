<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Restablecimientos.aspx.vb" Inherits="WebSIRECA.Restablecimientos" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Restablecimientos</title>
     <style type="text/css">
        body {
	        font-family: "Calibri";
        }
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            CellPadding="3" DataKeyNames="id" DataSourceID="SqlDataSourceRest" 
            Font-Size="9pt" HorizontalAlign="Center">
            <Columns>
                <asp:BoundField DataField="FECHA_MOV_RES" DataFormatString="{0:D}" 
                    HeaderText="FECHA_MOV_RES" SortExpression="FECHA_MOV_RES" />
        ...
        <asp:SqlDataSource ID="SqlDataSourceRest" runat="server" 
  ...
  ,afi.[fecha_mov] as [FECHA_MOV_RES]  
  ,eco.fechaEco 
  ,nl.[idEco]
