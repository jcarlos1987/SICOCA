<%@ Page Language="vb" MasterPageFile ="~/sitios/SiteCiclo2.Master" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="WebSIRECA._Default31" %>
...
WHEN ''DEPURADO RALE'' THEN ''DEPURACION RALE''
	ELSE ''POR COBRAR''
	END
)='''+@INCIDENCIA+''' and tipoEco in ('''+@TIPO_FILE+''')
