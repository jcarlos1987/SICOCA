<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteDelEjecutor.aspx.vb" Inherits="WebSIRECA.ReporteDelEjecutor" %>
...
<body style ="font-family: 'Calibri';" >
    ...
    <div>
        ...
        <table>
        <tr>
        <td><img alt="imss" class="style3" src="../imagenes/logoImss.png" /></td>
...
group by [REGPATR],[PERIODO],[NUMCRED],[INC_CAP]">
        ...
        <td style="text-align: center; border: thin solid #000000">Recibi<br />
            ...
            <%  If Session.Item("SIRECAsubdel").ToString.Equals("01") Then
                ...
                ElseIf Session.Item("SIRECAsubdel").ToString.Equals("33") Then
                    Response.Write("LIC. OLIMPIA VICTORIA GURUBEL<br />")
                    Response.Write("JEFE DE LA OFICINA PARA COBROS<br />")
                End If
                %>
