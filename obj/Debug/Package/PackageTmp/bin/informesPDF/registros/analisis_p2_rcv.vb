...
Public Class analisis_p2_rcv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.analisis_p2_rcv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedanalisis_p2_rcv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As analisis_p2_rcv = New analisis_p2_rcv()
        rpt.Site = Me.Site
        Return rpt
    End Function
