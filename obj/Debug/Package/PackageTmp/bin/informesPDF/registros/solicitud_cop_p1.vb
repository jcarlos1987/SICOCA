...
Public Class solicitud_cop_p1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.solicitud_cop_p1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsolicitud_cop_p1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As solicitud_cop_p1 = New solicitud_cop_p1()
        rpt.Site = Me.Site
        Return rpt
    End Function
