...
Public Class ceduladecaptura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.ceduladecaptura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedceduladecaptura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ceduladecaptura = New ceduladecaptura()
        rpt.Site = Me.Site
        Return rpt
    End Function
