...
Public Class rcv_moral_cit_not
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.rcv_moral_cit_not.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrcv_moral_cit_not
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rcv_moral_cit_not = New rcv_moral_cit_not()
        rpt.Site = Me.Site
        Return rpt
    End Function
