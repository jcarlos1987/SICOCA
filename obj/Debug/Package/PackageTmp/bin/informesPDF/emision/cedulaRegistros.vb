...
Public Class cedulaRegistros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.cedulaRegistros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcedulaRegistros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cedulaRegistros = New cedulaRegistros()
        rpt.Site = Me.Site
        Return rpt
    End Function
