...
Public Class facturaCredImp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.facturaCredImp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedfacturaCredImp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As facturaCredImp = New facturaCredImp()
        rpt.Site = Me.Site
        Return rpt
    End Function
