...
Public Class cop_fisica_cit_not
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.cop_fisica_cit_not.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcop_fisica_cit_not
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cop_fisica_cit_not = New cop_fisica_cit_not()
        rpt.Site = Me.Site
        Return rpt
    End Function
