Public Class _default43
    ...
    Protected Sub Page_Error(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Error
        Response.Write("Consulte el pago de la EMA de(l) " + Now.Month.ToString.Trim("D2") + "/" + Now.Year.ToString + ", para que se crea la base faltante.<br/> En MENU > RESUMEN DE PAGO > EMA")
    End Sub
    ...
    Protected Sub Repeater1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles Repeater1.ItemDataBound
        Try
            If e.Item.ItemIndex = 0 Then
                sumaTPro = IIf(IsNumeric(e.Item.DataItem(2)), CDbl(e.Item.DataItem(2)), 0)
                sumaTDif = IIf(IsNumeric(e.Item.DataItem(3)), CDbl(e.Item.DataItem(3)), 0)
            ...
            If e.Item.ItemIndex = 0 Or e.Item.ItemIndex = 1 Or e.Item.ItemIndex = 22 Or e.Item.ItemIndex = 23 Or e.Item.ItemIndex = 25 Or e.Item.ItemIndex = 26 Or e.Item.ItemIndex = 28 Or e.Item.ItemIndex = 33 Then
