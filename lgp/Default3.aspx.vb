    ...
    Protected Sub Repeater1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles Repeater1.ItemDataBound
        Try
            If IsNumeric(TBRevCuotas.Text) Then
                ...
                If e.Item.ItemIndex = 0 Or e.Item.ItemIndex = 1 Or e.Item.ItemIndex = 15 Or e.Item.ItemIndex = 16 Or e.Item.ItemIndex = 20 Or e.Item.ItemIndex = 24 Or e.Item.ItemIndex = 26 Or e.Item.ItemIndex = 31 Then
                ...
                End If
                If e.Item.ItemIndex = 17 Or e.Item.ItemIndex = 18 Or e.Item.ItemIndex = 19 Then
                    CType(e.Item.FindControl("Label3"), Label).Text = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & CType(e.Item.FindControl("Label3"), Label).Text
                End If
                If e.Item.ItemIndex = 27 Or e.Item.ItemIndex = 28 Or e.Item.ItemIndex = 29 Or e.Item.ItemIndex = 30 Then
                    CType(e.Item.FindControl("Label3"), Label).Text = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & CType(e.Item.FindControl("Label3"), Label).Text
                End If
                If Not e.Item.ItemIndex = 1 Then
                    If e.Item.ItemIndex = 31 Then
