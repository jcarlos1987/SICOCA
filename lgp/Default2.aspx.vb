    ...
    Protected Sub Repeater1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles Repeater1.ItemDataBound
        Try
            If IsNumeric(TBRevCuotas.Text) Then
                ...
                If e.Item.ItemIndex = 0 Or e.Item.ItemIndex = 1 Or e.Item.ItemIndex = 2 Or e.Item.ItemIndex = 3 Or e.Item.ItemIndex = 8 Or e.Item.ItemIndex = 9 Or e.Item.ItemIndex = 13 Then
                ...
                End If
                'Label3 un espacio
                If e.Item.ItemIndex = 3 Or e.Item.ItemIndex = 8 Or e.Item.ItemIndex = 9 Then
                    CType(e.Item.FindControl("Label3"), Label).Text = "&nbsp;&nbsp;&nbsp;&nbsp;" & CType(e.Item.FindControl("Label3"), Label).Text
                End If
                If (e.Item.ItemIndex >= 4 And e.Item.ItemIndex <= 7) Or (e.Item.ItemIndex >= 10 And e.Item.ItemIndex <= 12) Or (e.Item.ItemIndex >= 14 And e.Item.ItemIndex <= 17) Then
                    CType(e.Item.FindControl("Label3"), Label).Text = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & CType(e.Item.FindControl("Label3"), Label).Text
                End If
