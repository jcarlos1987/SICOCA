<%@ Page Language="vb" MasterPageFile ="~/sitios/SiteCiclo1.Master"  AutoEventWireup="false" CodeBehind="Default2.aspx.vb" Inherits="WebSIRECA._Default42x" %>
...
select * from (
SELECT ''1'' fila
,(SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=4) as CONCEPTO1
,((select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=4 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''')+'+'(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=5 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''')'+') as META1
,@VREC_MOD101317 as LGP1
union all
SELECT ''3'' fila
,(SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=8) as CONCEPTO2
,NULL as META2
,NULL as LGP2
union all
SELECT 
''4'' fila
,(SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=9) as CONCEPTO2
,NULL as META2
,NULL as LGP2
union all
SELECT 
''2'' fila
,(SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=1) as CONCEPTO1
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=1 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META1
,(@VCUO_OBR_PATRO+@OTROS_CONSEP) as LGP1
) as dato1
left join
(
SELECT ''1'' fila
,(SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=4) as CONCEPTO2
,NULL as META2
,NULL as LGP2
union all
SELECT 
''2'' fila
,(SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=1) as CONCEPTO2
,NULL as META2
,NULL as LGP2
union all
SELECT ''3'' fila
,(SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=8) as CONCEPTO2
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=8 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META2
,(@VREC_CARTE) as LGP2
union all
SELECT 
''4'' fila
,(SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=9) as CONCEPTO2
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=9 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META2
,@VING_FIS as LGP2
) as dato2 
...
--TOTAL
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=1) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=1 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,(@VMULTA+@VREC_MONA+@VACT+@VGAS_EJE+@VREC_MOD101317+@VOTRAS_MOD+@VCAP_CONST+@VREC_CARTE+@VING_FIS) as LGP
,((@VMULTA+@VREC_MONA+@VACT+@VGAS_EJE+@VREC_MOD101317+@VOTRAS_MOD+@VCAP_CONST+@VREC_CARTE+@VING_FIS)-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=1 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--CUOTA OBRERO PATRONALES
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=2) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=2 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,(@VREC_MOD101317+@VOTRAS_MOD+@VCAP_CONST+@VREC_CARTE+@VING_FIS) as LGP
,(@VREC_MOD101317+@VOTRAS_MOD+@VCAP_CONST+@VREC_CARTE+@VING_FIS-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=2 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--MODALIDADES
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=3) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=3 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,(@VREC_MOD101317+@VOTRAS_MOD+@VCAP_CONST) as LGP
,((@VREC_MOD101317+@VOTRAS_MOD+@VCAP_CONST)-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=3 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--RECAUDACION 10,13,17
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=4) as CONCEPTO
,((select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=4 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''')+'+@REVER_CUOTAS+') as META
,@VREC_MOD101317 as LGP
,(@VREC_MOD101317-((select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=4 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''')+'+@REVER_CUOTAS+'))as DIFERENCIA
--REVERSIO DE CUOTAS
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=5) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=5 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=5 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as LGP
,((select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=5 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''')-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=5 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--RECAUDACION OTRAS MODALIDADES
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=6) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=6 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,@VOTRAS_MOD as LGP
,(@VOTRAS_MOD-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=6 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--CAPITALES CONSTITUTIVOS
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=7) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=7 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,@VCAP_CONST as LGP
,(@VCAP_CONST-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=7 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--CORANZA
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=8) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=8 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,(@VREC_CARTE) as LGP
,((@VREC_CARTE)-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=8 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--FISCALIZACION
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=9) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=9 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,@VING_FIS as LGP
,(@VING_FIS-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=9 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--AUDITORIA
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=10) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=10 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,@VING_AUD as LGP
,(@VING_AUD-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=10 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--CORRECCION
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=11) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=11 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,@VING_COR as LGP
,(@VING_COR-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=11 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--DICTAMEN
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=12) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=12 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,@VING_DIC as LGP
,(@VING_DIC-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=12 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--DERIVADOS DE CUOTAS
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=13) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=13 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,(@VMULTA+@VREC_MONA+@VACT+@VGAS_EJE) as LGP
,((@VMULTA+@VREC_MONA+@VACT+@VGAS_EJE)-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=13 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--MULTAS
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=14) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=14 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,@VMULTA as LGP
,(@VMULTA-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=14 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--RECARGOS MONATORIOS
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=15) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=15 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,@VREC_MONA as LGP
,(@VREC_MONA-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=15 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--ACTUALIZACIONES
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=16) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=16 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,@VACT as LGP
,(@VACT-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=16 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
--GASTOS POR EJECUCION
union all
SELECT (SELECT [MET_CONSEPTO] FROM [sirecacobros].[dbo].[MET_CONSEPTO2014] WHERE [MET_ID]=17) as CONCEPTO
,(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=17 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+''') as META
,@VGAS_EJE as LGP
,(@VGAS_EJE-(select sum(MET_'+@NOM_MES3+') from sirecacobros.dbo.MET_METAS2014 where MET_ID_CONSEPTO=17 and MET_ANIO='+@ANIO+' and MET_SUBDEL like '''+@SUBDEL+'''))as DIFERENCIA
')
">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="DDLMes" DefaultValue="01" Name="?" 
