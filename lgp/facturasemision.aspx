<%@ Page Language="vb" MasterPageFile="~/sitios/SiteCiclo1.Master" AutoEventWireup="false" CodeBehind="facturasemision.aspx.vb" Inherits="WebSIRECA.facturasemision" %>
...
<div class="btn-group input-prepend">
    <asp:DropDownList ID="DDLSubdel" runat="server" AutoPostBack="True" 
        Width="150px" CssClass="btn dropdown-toggle">
        </asp:DropDownList>
<span class="add-on">
        ...
        Width="100px" CssClass="btn dropdown-toggle"></asp:DropDownList>
