...
Public Class ampliacionCop
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.ampliacionCop.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedampliacionCop
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ampliacionCop = New ampliacionCop()
        rpt.Site = Me.Site
        Return rpt
    End Function
