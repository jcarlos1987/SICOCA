...
Public Class mandamientoRcv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.mandamientoRcv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedmandamientoRcv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As mandamientoRcv = New mandamientoRcv()
        rpt.Site = Me.Site
        Return rpt
    End Function
