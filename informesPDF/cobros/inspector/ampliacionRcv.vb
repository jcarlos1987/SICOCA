...
Public Class ampliacionRcv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.ampliacionRcv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedampliacionRcv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ampliacionRcv = New ampliacionRcv()
        rpt.Site = Me.Site
        Return rpt
    End Function
