<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/sitios/SiteCiclo2.Master" CodeBehind="reporteasignacionpae.aspx.vb" Inherits="WebSIRECA.reporteasignacionpae" %>
                ...
                <asp:TemplateField HeaderText="INSPECTORES" SortExpression="FECHA_ASIGNACION">
                    <ItemTemplate>
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" 
                            ...
                            <ItemTemplate >
                                <asp:LinkButton ID="LinkButton2" runat="server" OnClick='<%# "javascript:window.open(""rep_asigconcredito.aspx" & Eval("urlv") & """,""imprimir"",""top=50, left=300,menubar=0,toolbar=0,directories=0, location=0, status=0, height=500, width=800, scrollbars=1"");" %>'  Text='<%# Eval("INSPECTOR") %>' ></asp:LinkButton>
                                <br />
                            </ItemTemplate>
                        </asp:Repeater>
