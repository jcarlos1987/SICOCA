...
Public Class mandamientoCop
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.mandamientoCop.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedmandamientoCop
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As mandamientoCop = New mandamientoCop()
        rpt.Site = Me.Site
        Return rpt
    End Function
