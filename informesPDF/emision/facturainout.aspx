<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="facturainout.aspx.vb" Inherits="WebSIRECA.facturainout" %>
...
<body>
    ...
    <asp:Panel ID="PanelRead" runat="server" HorizontalAlign="Center">
        ...
        <asp:Label ID="Label2" runat="server" 
            Text="Imprimir factura de:" ForeColor="#CC0000"></asp:Label>
        </span>
        <asp:DropDownList ID="DDLRegCodeBar" runat="server" 
                DataSourceID="SqlDataSourceRegCodeBar" DataTextField="texto" 
                DataValueField="valor" ForeColor="Red" Width="300px" AutoPostBack="True">
        </asp:DropDownList>
...
WHERE [AC_OFICINA] like @CARGO and [AC_CARGO] like @DOC_OFIC">
        ...
        <span class="add-on">
            <asp:HyperLink ID="HLPrint" runat="server" CssClass="btn" 
                NavigateUrl="~/informesPDF/emision/facturainouttipo.aspx?msg1=99999&msg2=999999" Target="_blank"><i class="icon-print"></i></asp:HyperLink>
        </span> 
        </div> 
    </asp:Panel>
    &nbsp;</form>
