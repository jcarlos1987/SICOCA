<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ceduladecaptura.aspx.vb" Inherits="WebSIRECA.ceduladecaptura1" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSourceCedulaCaptura" runat="server">
            <Report FileName="ceduladecaptura.rpt">
                <DataSources>
...
,(CASE 
WHEN V_INC_CAPTURA in (''2'') and [V_SUBDEL] in (''33'') THEN ''31''
WHEN V_INC_CAPTURA in (''2'') THEN (case when sirecacobros.dbo.diasInabiles('''+@FECHA_DILIGENCIA+''',getdate())&gt;14 then ''31'' else ''02'' end) 
