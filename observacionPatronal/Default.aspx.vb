...
Public Class _Default13
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Try
            ...
            Dim rutaInc32 As String = Server.MapPath("~") & "\fotosIncidencia\" & Request.QueryString("regpat").ToString.Replace("-", "").Substring(0, 10).ToUpper & "\32"
            If System.IO.Directory.Exists(rutaInc32) Then
                Dim imagenes As String() = Directory.GetFiles(rutaInc32)
                ...
                For index As Integer = 0 To (imagenes.Length - 1)
                    ...
                    HFImagenes32.Value += ",{ 'caption': '" & nombrefile & "', 'url': '../fotosIncidencia/" & Request.QueryString("regpat").ToString.Replace("-", "").Substring(0, 10).ToUpper & "/32/" & nombrefile & "' }"
                Next
        ...
        Else
            ...
            If (Session.Item("SIRECAobservacionPatronal").ToString.Equals("1") Or Session.Item("SIRECAobservacionPatronal").ToString.Equals("2")) And Session.Item("SIRECAchmod7").ToString.Equals("x") Then
                Try
                    ...
                    HLAsignar.NavigateUrl = "~/pag_asps/asignardeudameses.aspx?regpat=" & LRegpat.Text
    ...
    Protected Sub LBApliPAE_Init(ByVal sender As Object, ByVal e As EventArgs) Handles LBApliPAE.Init
        LBApliPAE.PostBackUrl = "~/cobrosv2/default.aspx?r=" + Request.QueryString("regpat")
    End Sub
End Class