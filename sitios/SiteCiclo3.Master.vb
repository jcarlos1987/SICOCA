...
Public Class SiteCiclo3
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            If Not (Session.Item("SIRECAuser_type").ToString.Equals("0") And Session.Item("SIRECAchmod3").ToString.Equals("x") And Session.Item("SIRECAchmod7").ToString.Equals("x")) Then
