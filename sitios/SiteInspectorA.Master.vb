...
Public Class SiteInspectorA
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            If Not ((Session.Item("SIRECAuser_type").ToString.Equals("1") Or Session.Item("SIRECAuser_type").ToString.Equals("9")) And Session.Item("SIRECAchmod1").ToString.Equals("x") And Session.Item("SIRECAchmod7").ToString.Equals("x")) Then
