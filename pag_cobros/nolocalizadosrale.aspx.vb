...
Public Class nolocalizadosrale
    ...
    Protected Sub GridView1_PreRender(ByVal sender As Object, ByVal e As EventArgs) Handles GridView1.PreRender
        CType(sender, GridView).Caption = CInt(GridView2.Rows(0).Cells(0).Text).ToString("N0") + " PATRONES, " + CType(sender, GridView).Rows.Count.ToString("N0") + " CREDITOS, <strong>NO LOCALIZADOS CONFIRMADOS</strong>"
    End Sub

    Protected Sub LBExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles LBExportar.Click
        ExportToExcel(Now.Day.ToString("D2") + Now.Month.ToString("D2") + Now.Year.ToString("D4") + "NoLocalizados", GridView1)
    End Sub
    ...
    Protected Sub DDLMes_Load(ByVal sender As Object, ByVal e As EventArgs) Handles DDLMes.Load
