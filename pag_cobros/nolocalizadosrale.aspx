<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/sitios/SiteCiclo2.Master" CodeBehind="nolocalizadosrale.aspx.vb" Inherits="WebSIRECA.nolocalizadosrale" %>
<asp:Content ID="contenido1" runat="server" ContentPlaceHolderID ="ContentPlaceHolder1" >
    ...
    <div class="btn-group input-prepend">
        ...
        <asp:LinkButton ID="LBExportar" CssClass="btn" runat="server">Exportar</asp:LinkButton>
            ...
            DataSourceID="SqlDataSource2" ForeColor="White" ShowHeader="False">
                        <Columns>
...
and INC=''09''
GROUP BY [AC_SUBDEL],[AC_RA_REGPATR],[AC_RA_NUMCRED],[AC_RA_PERIODO],INC
) AS SR1 
...
">
            ...
            Caption="&lt;strong&gt;NO LOCALIZADOS CONFIRMADOS&lt;/strong&gt;" 
