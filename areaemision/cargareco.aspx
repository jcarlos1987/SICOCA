<%@ Page Language="vb" MasterPageFile ="~/sitios/SiteCiclo1.Master"  AutoEventWireup="false" CodeBehind="cargareco.aspx.vb" Inherits="WebSIRECA.cargareco" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:SqlDataSource ID="SqlDataSourceCOP" runat="server" 
                                    ...
                                    ProviderName="<%$ ConnectionStrings:ConnectionStringMaster.ProviderName %>" SelectCommand="SELECT TOP 4 subdel as SUBDEL
,(case 
