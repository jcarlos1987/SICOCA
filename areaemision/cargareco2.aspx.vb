...
Public Class cargareco2
    ...
    Protected Sub setsectores(ByVal ruta As String)
        ...
        While fs.Peek > -1
            ...
            End If
            If fila.Length = 170 Then
                fila = fila.Insert(16, ";") '0
                fila = fila.Insert(30 + 1, ";") '1
    ...
    Private Function subirAlServidor63(ByVal ruta As String, ByVal istiporcv As Boolean)
        ...
        Try
            ...
            textConmand += " [a63_tp] [nvarchar](255) NULL, "
    ...
    Private Function addEcos(ByVal esRcv As Boolean) As String
        ...
        Try
            ...
            textConmand += " ," + TBCifraControl.Text + " as [clave] "
            ...
            textConmand += " ,'SIN PAGO' as [validacion] "
            textConmand += " ,null as [pago] "
            textConmand += " ,null as [fech_pago] "
            textConmand += " ,'00' as [incidenciarale] "
            If tipoeco.Contains("RCV") Then
                textConmand += " ,'06' as [tdrale] "
            Else
                textConmand += " ,'02' as [tdrale] "
            End If
