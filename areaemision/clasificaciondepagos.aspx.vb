...
Public Class clasificaciondepagos
    ...
    Protected Sub GVRecaudacion0_PreRender(ByVal sender As Object, ByVal e As EventArgs) Handles GVRecaudacion0.PreRender
        GVRecaudacion0.Caption = GVRecaudacion0.Rows.Count & " FECHAS DE RECAUDACION C.O.P. Y R.C.V."
    End Sub
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        Catch ex As Exception
            If Not ex.Message.Equals("Query timeout expired") Then
                LMsg.Text = " Seleccione una Subdelegación"
            End If
        End Try
    End Sub

    Protected Sub BActualizar0_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BActualizar0.Click
        Try
            LMsg.Text = ""
            Dim vsubdel As String = DDLSubdel.SelectedValue
            Dim vperiodo As String = DDLMes.SelectedValue + DDLAnio.SelectedValue
