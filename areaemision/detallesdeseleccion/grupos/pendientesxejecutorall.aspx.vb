...
Public Class pendientesxejecutorall
    ...
    Protected Sub GridView1_PreRender(ByVal sender As Object, ByVal e As EventArgs) Handles GridView1.PreRender
        GridView1.Caption = String.Format(New CultureInfo("es-MX"), "{0:N0}", Convert.ToInt32(Request.QueryString("patrones").ToString)) & " PATRONES" _
        ...
        & ", " & String.Format(New CultureInfo("es-MX"), "{0:C}", Convert.ToDouble(Request.QueryString("importe").ToString)) & " importe"
    End Sub
