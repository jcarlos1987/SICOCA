<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CERRAJERO.aspx.vb" Inherits="WebSIRECA.CERRAJERO" %>
...
<body style="background-color: #D6D3CE">
    ...
    <center >
        <rsweb:ReportViewer ID="ReportViewer2" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="pag_paes\Cerrajero.rdlc">
                <DataSources>
...
where regpatr=? and grupo='PAE'  and inc in ('31','32','43')
