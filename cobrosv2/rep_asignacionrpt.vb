...
Public Class rep_asignacionrpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.rep_asignacionrpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_asignacionrpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_asignacionrpt = New rep_asignacionrpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
