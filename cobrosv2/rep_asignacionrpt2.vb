...
Public Class rep_asignacionrpt2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.rep_asignacionrpt2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_asignacionrpt2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_asignacionrpt2 = New rep_asignacionrpt2()
        rpt.Site = Me.Site
        Return rpt
    End Function
