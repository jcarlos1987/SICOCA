...
Public Class mandamientov2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.mandamientov2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmandamientov2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As mandamientov2 = New mandamientov2()
        rpt.Site = Me.Site
        Return rpt
    End Function
