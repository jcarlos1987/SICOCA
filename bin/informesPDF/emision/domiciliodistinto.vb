...
Public Class domiciliodistinto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.domiciliodistinto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheddomiciliodistinto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As domiciliodistinto = New domiciliodistinto()
        rpt.Site = Me.Site
        Return rpt
    End Function
