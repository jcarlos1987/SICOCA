...
Public Class analisis_p1_cop
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.analisis_p1_cop.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedanalisis_p1_cop
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As analisis_p1_cop = New analisis_p1_cop()
        rpt.Site = Me.Site
        Return rpt
    End Function
