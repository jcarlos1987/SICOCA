...
Public Class solicitud_rcv_p2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebSIRECA.solicitud_rcv_p2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsolicitud_rcv_p2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As solicitud_rcv_p2 = New solicitud_rcv_p2()
        rpt.Site = Me.Site
        Return rpt
    End Function
